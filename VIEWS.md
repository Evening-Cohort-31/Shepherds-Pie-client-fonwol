...
**Features**
- **View Current Pizzas**
  - Each pizza shows *Edit* / *Delete* options  
  - *Edit* → routes to **Pizza Edit View** (fields pre-filled)  
  - *Delete* → confirmation prompt, then returns to Order Detail View
...
- **Add Delivery Assignment**
  ...
  - *(Optional)* Notifies assigned employee
- **Submit Order**
...
**Features**
- Date selection input (defaults to *today*)  
...
- Current order status (*In the Oven*, *Out for Delivery*, *Complete*, etc.)
...
#### Employee View
- Displays logged-in employee’s information  
- Allows editing *only* their own data  
- Error displayed if attempting to access other employees’ profiles

#### Employee Admin View
- Displays all employee records  
- Allows admins to view and edit all employee information

---

### 🔐 Login View
Simple login form for employee authentication.  
Redirects to **Orders List View** upon successful login.
